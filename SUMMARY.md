...
* [Introduction](overview/quickstart.md)
* [Architecture](overview/publish-your-docs.md)
* [Components & Features](overview/components-and-features.md)
...
* [Tutorials](quick-start/tutorials.md)

## Use cases

* [Malicious Hook Detection](use-cases/malicious-hook-detection.md)
* [Vulnerable Hook Detection](use-cases/vulnerable-hook-detection.md)
